...
export function SkeletonHeading({ className = '' }: { className?: string }) {
  return (
    <div className={`h-6 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-48 skeleton ${className}`} />
  )
}
...
export function SkeletonParagraph({ className = '' }: { className?: string }) {
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-full skeleton" />
      <div className="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-2/3 skeleton" />
    </div>
  )
}
