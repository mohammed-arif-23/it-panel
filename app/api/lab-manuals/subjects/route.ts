...
// GET /api/lab-manuals/subjects?dept=IT&year=1st%20year&semester=Semester%201
// Returns subjects for lab manuals from subjects table, filtered for practical courses
