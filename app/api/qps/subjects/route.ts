...
// GET /api/qps/subjects?dept=IT&year=1st%20year&semester=Semester%201
// Returns subjects for the selected dept/year/semester from subjects table only
export async function GET(req: NextRequest) {
  try {
    ...
    console.log('Using department for subjects query:', { dept: dbDepartment })
